...
Currently working Level 1 IT Support while building hands-on Systems/Network/Security skills through a self-managed home lab, with the goal of moving into a Cybersecurity Analyst or Cloud Support role. Studying CompTIA A+ → Network+ → Security+ → CySA+ alongside full-time work.

## Skills

| Skill | Associated Project |
|---|---|
| Windows VMs Home Lab Setup (AD / GPO / File Sharing / FSRM / ABE) | [Windows-AD-GPO-Home-Lab-Project](https://github.com/Th3Slime/Windows-AD-GPO-Home-Lab-Project) |
| Network Scanner with nmap | [Network-Scanner-with-nmap](https://github.com/Th3Slime/Network-Scanner-with-nmap) |
| Password Auditing with John the Ripper | [Password-Auditing-with-John-the-Ripper](https://github.com/Th3Slime/Password-Auditing-with-John-the-Ripper) |
| Firewall Configuration with UFW (Uncomplicated Firewall) | [Firewall-Configuration-with-UFW-Uncomplicated-Firewall-](https://github.com/Th3Slime/Firewall-Configuration-with-UFW-Uncomplicated-Firewall-) |
| Set up home network diagram | *in progress* |
| Network traffic analysis (Wireshark labs) | *documenting now — repo coming soon* |
